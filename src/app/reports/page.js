  ...
  return (
    <div className={styles.container}>
      <Card title="Hospital Reports">
        <p>Access various reports for hospital operations, patient data, staff activity, and financials.</p>
        <div className={styles.buttonGroup}>
          ...
          <Link href="/reports/staff-activity" passHref legacyBehavior><Button>Staff Activity</Button></Link>
