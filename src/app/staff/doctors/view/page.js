// filepath: /Users/alsammany/Documents/Personal/SPRING 25/Database/Project/GUI/hospital/src/app/staff/doctors/view/page.js
'use client';
    ...
    <div className={styles.container}>
      <Card title={`View ${staffType}`}>
        <form onSubmit={handleSearchSubmit} className={styles.searchContainer}>
          <Input
            type="text"
            placeholder={`Search ${staffType.toLowerCase()} by name, email, ID, or specialization...`}
            value={searchTerm}
