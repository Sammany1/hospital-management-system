...
export default function TechniciansPage() {
  ...
  const basePath = "/staff/technicians";
  const addPath = "/staff/technicians/add-technician"; // Assuming a specific add page

  return (
    <div className={styles.container}>
      <h1 className={styles.mainTitle}>Manage {categoryName}</h1>
      <p className={styles.subTitle}>Add new technicians, view existing staff, or generate reports.</p>
