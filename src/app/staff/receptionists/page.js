...
export default function ReceptionistsPage() {
  ...
  const basePath = "/staff/receptionists";
  const addPath = "/staff/receptionists/add-receptionist";

  return (
    <div className={styles.container}>
      <h1 className={styles.mainTitle}>Manage {categoryName}</h1>
      <p className={styles.subTitle}>Add new receptionists, view existing staff, or generate reports.</p>
