// filepath: /Users/alsammany/Documents/Personal/SPRING 25/Database/Project/GUI/hospital/src/app/staff/other/add-other/page.js
'use client';
...
export default function AddOtherStaffPage() {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case 'clearance_level':
        if (formData.employee_type === 'Security' && !value) error = 'Clearance level is required for Security staff.';
        break;
      case 'badge_number':
        if (formData.employee_type === 'Security' && !value) error = 'Badge number is required for Security staff.';
        break;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('/api/staff/other/add-other', {
        method: 'POST',
  ...
  return (
    <div className={styles.formContainer}> 
      <Card title="Add New Staff Member (Other Roles)">
