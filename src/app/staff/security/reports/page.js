...
export default function SecurityReportsPage() {
  ...
  return (
    <div className={styles.container}>
      <Card title={`${staffType} Staff Activity Report`}> {/* Changed title */}
        ...
        {!loading && !error && !reportData && (
            <p>No report data available for {staffType.toLowerCase()} staff at this time.</p>
        )}
      </Card>
    </div>
  );
